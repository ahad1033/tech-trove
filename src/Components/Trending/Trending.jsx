  ...
  return (
    <div className="section-container">
      <div className="flex justify-between items-center my-12">
        <h3 className="text-2xl mb-2">Trending Must Have</h3>
        <button className="text-white btn btn-active btn-link">view all</button>
      </div>
      ...
      <div className="flex flex-col md:flex-row lg:flex-row items-center justify-center gap-10 lg:gap-20">
        <div className="w-96 px-10 md:px-0 lg:px-0">
          ...
          <div
            className="flex flex-col lg:flex-row justify-between bottom-0 text-white p-4"
