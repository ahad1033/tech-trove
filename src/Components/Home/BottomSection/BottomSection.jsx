...
const BottomSection = () => {
    return (
        <div className='relative lg:mt-80 md:mt-28 sm:mt-16'>
            ...
            <div className='w-full items-center lg:px-60 md:px-40 sm:px-20 lg:pt-32 md:pt-24 sm:pt-10 lg:pb-32 md:pb-24 sm:pb-20 lg:gap-32 md:gap-14 sm:gap-10 grid lg:grid-cols-4 grid-cols-2' style={{ backgroundColor: '#d1e2eb' }}>
