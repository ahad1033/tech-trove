    ...
    return (
        <div className='relative mt-16 md:mt-28 lg:mt-80'>
            <div className='w-2/5 h-96 absolute inset-1/2 transform -translate-x-1/2  text-center px-36 py-20 rounded-xl -top-56  hidden lg:block' style={{ backgroundColor: '#7296AB' }}>
                <h1 className='mb-10 text-5xl text-white'>Tech<span className='font-bold'>Trove</span></h1>
            ...
            <div className='w-full grid grid-cols-2 lg:grid-cols-4  items-center px-3 md:px-40 lg:px-60 md:pt-15 lg:pt-32 md:pb-15 lg:pb-32 lg:gap-32 text-black text' style={{ backgroundColor: '#d1e2eb' }}>
                ...
                <div className='items-start my-6 p-10'>
                    <h3 className='font-bold text-sm md:text-lg lg:text-lg'>How to Buy</h3>
