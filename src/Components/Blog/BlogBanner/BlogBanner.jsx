        ...
        <div className='mx-auto bg-cover bg-center lg:px-32 md:px-10 sm:px-20 py-7 md:py-24 lg:py-36' style={{ backgroundImage: `url(https://i.ibb.co/9wk7cBx/stunning-barefooted-woman-trendy-fur-coat-dancing-laughing-photoshoot-1.png)`, backgroundRepeat: 'no-repeat' }}>
            <div className='flex'>
                ...
                <div>
                    ...
                    <p className='md:uppercase lg:uppercase text-xs md:text-lg lg:text-2xl text-white mt-3 md:mt-5 lg:mt-12 w-[200px] md:w-[500px] lg:w-[500px]'>In the heart of a chic urban studio, the atmosphere buzzed with excitement as a trendy fur coat took center stage during a vibrant photoshoot.</p>
