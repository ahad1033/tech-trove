...
const TopCard = () => {
    return (
        <div className='lg:flex md:hidden sm:hidden gap-4 justify-center'>
            <div className='flex'>
                <div className="w-96 h-full" style={{ backgroundColor: "#E9E9EB" }}>
                ...
                <div className='w-96'>
                    <img className='h-full w-full object-cover' src="https://i.ibb.co/RgxYVPy/stylish-woman-summer-outfit-isolated-posing-fashion-trend-isolated-1-1.png" alt="" />
                </div>
                <div className='w-96 ms-4'>
                    <img className='h-full w-full object-cover' src="https://i.ibb.co/fqr6s63/4448fd67219a276a985ebc0dd4e94d09.png" alt="" />
                </div>
            </div>
        </div>
    );
