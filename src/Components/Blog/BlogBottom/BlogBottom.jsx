...
const BlogBottom = () => {
  return (
    <div
      className="section-container py-11 flex flex-col md:flex-row lg:flex-row gap-5 justify-between  lg:gap-32 my-12"
    ...
    >
      <div className="w-full lg:w-1/3 items-start sm:items-center text-center md:text-start lg:text-start px-4 md:px-0 lg:px-0">
        ...
        <p className="mb-5  text-white font-semibold text-sm lg:text-xl">
          Your trusted shop for your daily needs
        </p>
      ...
      <div className="w-full lg:w-2/3 px-5 md:px-0 lg:px-0 text-sm items-center flex justify-between text-white">
