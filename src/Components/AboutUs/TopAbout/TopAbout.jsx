    ...
    return (
        <div className='section-container flex items-center my-10 sm:gap-10 md:gap-20 lg:gap-36'>
            <div className='lg:w-2/3 md:w-2/3 sm:w-1/2'>
                <p className='sm:text-lg md:text-2xl lg:text-2xl mb-4'>Let's get to know TechTrove</p>
                <h1 className='sm:text-3xl md:text-3xl lg:text-6xl leading-normal'>Providing the best experience to make your <span style={{color: '#3E60C9'}}>Online Shopping</span> </h1>
            ...
            <div className='flex sm:w-1/2 md:w-1/3 lg:w-1/3 justify-center items-center'>
